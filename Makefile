...
SOURCES +=	$(IMPL_DIR)imgui_impl_opengl2.cpp \
			$(IMPL_DIR)imgui_impl_glut.cpp
...
CXXFLAGS += -g
LIBS = -lpthread -lm -limebra -lGL -lglut
##---------------------------------------------------------------------
## OPENGL LOADER
##---------------------------------------------------------------------
...
CXXFLAGS += -L/home/mhoncharuk/Education/Medical_Visuals/rt_client/imebra_lib/
